  ...
  return <>
        ...
        <div id="header-client"className="header-blue">
            <nav id="navbar-client" style={{zIndex:"100"}}className="navbar navbar-light  navbar-expand-md ">
                <div className="container-fluid"><a className="navbar-brand" href="./"><img src={Logo} style={{widhth:"50px",height:"50px",marginRight:"12px"}}/>OLÉ PRODUCTOS CAPILARES</a><button data-toggle="collapse" className="navbar-toggler" data-target="#navcol-1"><span className="sr-only">Toggle navigation</span><span className="navbar-toggler-icon"></span></button>
                    <div className="collapse navbar-collapse"
                        id="navcol-1">
                        <ul className="nav navbar-nav mx-auto">
                            <li className="" role="presentation"><a className="nav-link" href="/">Inicio</a></li>
                            <li className="nav-item" role="presentation"><a className="nav-link" href="#">Quienes Somos</a></li>
                            <li className="nav-item" role="presentation"><a className="nav-link" href="/all-products">Menu</a></li>
                        </ul>
                        {
            ...
            <div className=" image-header container hero" id="image-header">
                <div className="row">
                    <div className="">
                        <h1>NUESTROS PRODUCTOS CAPILARES.</h1>
